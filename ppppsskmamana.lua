...
Window = Library:CreateWindow({
    Title = 'DYHUB | ' .. getgenv().build .. ' | ' .. getgenv().Version ..'| ' .. getgenv().injectorActive,
    Center = true,
    AutoShow = true,
    TabPadding = 2,
    MenuFadeTime = 0.2
...
info:AddDivider()
info:AddLabel('DYHUB.lua is a free script')
...
info:AddButton({
    ...
    Tooltip = 'https://dsc.gg/dyhub // copies discord link to clipboard',
    Func = function()
        setclipboard("https://dsc.gg/dyhub")
        Library:Notify("https://dsc.gg/dyhub set to clipboard")
    end
})
info:AddButton({
    Text = 'copy username',
    Tooltip = 'dyumra // copies the owners username to clipboard',
    Func = function()
        setclipboard("dyumra")
        Library:Notify("dyumra set to clipboard")
    end
})
