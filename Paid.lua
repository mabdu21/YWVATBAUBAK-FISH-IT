...
- [ Added ] Bypass Jeffrey / forces every Jeffrey no bother you, event scan
- [ Fixed ] Shop Hourly use the correct value for remote firing
- [ Improved ] Bug issues, farming system, mode farm]],
})
Info:Divider()
