...
Info:Paragraph({
    ...
    Desc = "- [ New ] Priority System: GiantST → Heli → HighHP (>300) → Nearest\n- [ New ] Interrupt: ถ้ากำลังตีมอนอื่นแล้ว Priority mob ใหม่ปรากฏ → สลับทันที\n- [ Fixed ] Auto Vote & Start Sync\n- [ Improved ] Auto Vote & Start loop on respawn",
